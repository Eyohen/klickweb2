...
const Profile = () => {
    return (
        <div className=" mx-auto border-2 border-gray-200 rounded-xl flex flex-col space-y-5 max-w-md">
            <img src={ProfileImage} alt="Profile" className="rounded-t-xl max-w-md" />
            <div className="flex justify-between items-center px-4 bg-gray-50 py-4">
                <div className="flex justify-between items-center gap-4">
                    <img src={ProfileIcon} alt="Profile" className="w-12" />
                    <div className="flex flex-col gap-1">
                        <h1 className="font-bold text-xl">The Cuddle Club</h1>
                ...
                <button className="text-black rounded-full bg-secondary px-3 py-2">Contact</button>
            </div>
            <div className="py-4 flex flex-col gap-4 px-4">
                <p className="font-semibold">Overview</p>
                <p className="text-gray-300">
                    Lorem ipsum dolor sit, amet consectetur adipisicing elit. Neque illo tenetur architecto voluptatem error? laudantium, quidem odit voluptas, labore in voluptatum et voluptate nesciunt ducimus. Cum.{' '}
                    <span className="text-primary">Read more</span>
                </p>
                <p className="font-semibold">Monday - Friday: <span className="text-primary font-normal">10:00 - 22:00</span></p>
                <p className="font-semibold">Monday - Friday: <span className="text-primary font-normal">10:00 - 22:00</span></p>
            </div>
