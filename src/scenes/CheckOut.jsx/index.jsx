...
function CheckOut() {
  ...
  useEffect(() => {
    const ksecureCommissionValue =
      selectedShipmentMethod !== "seller" ? ksecureCommission : 0;
  ...
  useEffect(() => {
    ...
    const getShippingOptions = async () => {
      ...
      const shippingOptionsResponse = await axios.get(
        "https://klick-api.onrender.com/cart/checkout/rates",
        {
          headers: {
            Authorization: `Bearer ${token}`,
            "Content-Type": "application/json",
            ...
            <div className="space-y-5">
              ...
              <div className="flex justify-between">
                ...
                <p className="text-blue-500">
                  N{selectedCourier?.total ? selectedCourier.total : "0.00"}
                </p>
              </div>
              <div className="flex justify-between">
