...
import img1 from '@/assets/GridItem.png'
  ...
  return (
    <div>
        <div className='w-[1252px]  bg-gray-200 rounded-lg mx-auto px-4 py-[20px] mt-10 '>
            ...
            <svg className='w-4 h-4 text-gray-700' fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
...
<p className=''>Camera</p>
            ...
            <svg className='w-6 h-6 text-red-700' fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
