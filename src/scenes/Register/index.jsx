        ...
        <div className="flex flex-col items-center w-[25%] mx-auto space-y-5 mt-20">
            ...
            <form className='flex flex-col w-full'  onSubmit={handleSubmit}>
                ...
                <div className='mb-4 relative items-center'>
                    ...
                    <div className='w-full flex justify-between border border-gray-200 bg-gray-50 outline-none rounded-md px-4 py-2  text-gray-600  focus:ring-secondary focus:border-secondary 'tabIndex="0" >
                    <div className="mr-2">
                <img className=' w-7 h-7 ' src='https://www.svgrepo.com/show/405569/flag-for-flag-nigeria.svg'/>
                </div>
                    <input type="text" name="phone" id="phone" placeholder='+2348152380723' className={` w-full outline-none px-3 bg-inherit text-gray-600 !border-0 !outline-0 focus:!border-0 focus:!outline-0 `} value={values.phone} onChange={handleChange}/>
                    </div>
    </div>
