                ...
                <div className=' w-7/12'>
                    ...
                    <div className='block p-6 bg-white border border-gray-200'>
                        <div className='flex justify-between items-center'>
                            ...
                            <div>
                                <button>
                                    <BsExclamationCircleFill className=' text-gray-500' size={24} />
                                </button>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='mb-6'>
                        ...
                        <div className='block p-6 bg-white border border-gray-200 rounded-b-lg'>
                            ...
                            <div className=' flex justify-between items-center'>
                                ...
                                <span type="button" class="px-2 py-1 text-xs font-medium text-center text-gray-500 bg-gray-200 rounded-lg ">Ongoing</span>
                            </div>
                        </div>
                    </div>
                            ...
                            <div className=' flex justify-between items-center'>
                                <div className='flex gap-4 items-center'>
                                    ...
                                    <div className=' space-y-1'>
                                        ...
                                        <p className=' text-xs text-gray-400'>Your order has been confirmed</p>
                                    </div>
                                </div>
                        ...
                        <div className='block p-6 bg-white border border-gray-200'>
                            <div className=' flex justify-between items-center'>
                                <div className='flex gap-4 items-center'>
                                    ...
                                    <div className=' space-y-1'>
                                        <p className=''>Order Confirmed</p>
                                        <p className=' text-xs text-gray-400'>Track your order <span className=' text-blue-500'>- shipbubble.com/tracking</span></p>
                                    </div>
                                </div>
